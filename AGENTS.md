# AGENTS.md — Istruzioni di progetto per agenti AI
...
app/                     dashboard FastAPI
  ...
  mcp_server.py           server MCP in sola lettura per Codex (routine, segmenti, metriche)
  services/
...
- Branch di lavoro: `Codex/italian-hotel-restaurant-scraper-0ktjlu`.
